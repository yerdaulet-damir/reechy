...
export default function Home() {
  ...
  // Landing Page - High-converting Fast Pitch Video structure with Inline Camera
  if (step === 'landing') {
    return (
        ...
        <nav className="relative z-10 w-full px-6 py-6 md:px-12 md:py-8 lg:px-24 mx-auto max-w-[1440px] flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Button
              ...
              className="bg-[#0066FF] text-white hover:bg-[#0052CC] rounded-full px-6 py-5 h-auto text-[14px] font-bold transition-all shadow-[0_4px_12px_rgba(0,102,255,0.25)]"
            >
              Contact Sales
            </Button>
          </div>
        ...
        <main className="relative z-10 flex-1 w-full flex items-center max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24 pb-20 pt-8">
          <div className="flex flex-col xl:flex-row items-center xl:items-start justify-between w-full gap-16 xl:gap-12">
            ...
            <div className="w-full xl:w-[45%] flex justify-center xl:justify-end shrink-0 perspective-[1200px]">
              <div className="relative w-full max-w-[500px] aspect-[4/5] sm:aspect-square xl:aspect-auto xl:h-[640px] transform-gpu transition-all duration-[800ms] hover:-translate-y-2 hover:shadow-[0_40px_80px_rgba(0,0,0,0.1)] rounded-[32px] md:rounded-[40px] shadow-[0_20px_60px_rgba(0,0,0,0.06)] bg-white/60 dark:bg-[#111]/80 backdrop-blur-2xl ring-1 ring-black/5 dark:ring-white/10 p-2 md:p-3 flex flex-col group cursor-pointer" onClick={handleStartRecording}>
                <div className="w-full h-full relative rounded-[24px] md:rounded-[32px] bg-black isolation-auto will-change-transform overflow-hidden">
                  <CameraInterface onVideoComplete={handleVideoComplete} inline />
                  {/* Subtle overlay hint */}
                  <div className="absolute inset-0 z-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/20 backdrop-blur-sm pointer-events-none">
        ...
        <section className="relative z-10 w-full bg-[#FAFAFA] dark:bg-[#0A0A0A] py-32 border-t border-black/5 dark:border-white/5 text-center">
           <div className="max-w-3xl mx-auto px-6 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4 items-center">
                <Button
                  onClick={handleStartRecording}
                  className="bg-[#0066FF] text-white hover:bg-[#0052CC] rounded-full px-8 h-14 text-[15px] font-bold transition-all shadow-[0_4px_12px_rgba(0,102,255,0.25)]"
                >
                  Start Recording
                </Button>
